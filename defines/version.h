...
static constexpr size_t GetMonthFromDate() {
    return (__DATE__[0] == 'J') ? (
             (__DATE__[1] == 'a') ? 0x00000100 : ((__DATE__[2] == 'n') ? 0x00000600 : 0x00000700))    // Jan, Jun or Jul
           : (__DATE__[0] == 'F') ? 0x00000200                                                        // Feb
           : (__DATE__[0] == 'M') ? ((__DATE__[2] == 'r') ? 0x00000300 : 0x00000500)                  // Mar or May
           : (__DATE__[0] == 'A') ? ((__DATE__[2] == 'p') ? 0x00000400 : 0x00000800)                  // Apr or Aug
...
static constexpr size_t GetVersion() {
    ...
    ver |= (size_t)(__DATE__[4] == ' ' ? 0 : (__DATE__[4] - '0')) << 4;    // Most significant digit of the day.
