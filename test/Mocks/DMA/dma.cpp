...
uint32_t __HAL_DMA_GET_COUNTER(DMA_HandleTypeDef* handle) { return handle->counter; }

void __NILAI_DMA_SET_COUNTER(DMA_HandleTypeDef* handle, size_t count) { handle->counter = count; }
